...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.syd.common.io.stream .ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.syd.common.io.stream.ByteArrayOutputStream output = new com.syd.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link com.syd.common.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.syd.common.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
