    ...
    public AdapterView.OnItemClickListener getOnItemClickListener() {
        return new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (itemAdapter instanceof IbFaceFragment.EmotionGridViewAdapter) {
                    // 点击的是表情
                    IbFaceFragment.EmotionGridViewAdapter emotionGvAdapter = (IbFaceFragment.EmotionGridViewAdapter) itemAdapter;
                    ...
                    if (position == emotionGvAdapter.getCount() - 1) {
                        ...
                        try{
                            ...
                            // 特殊文字处理,将表情等转换一下
                            mEditText.setText(SpanStringUtils.getEmotionContent(
